...
[visualisation
vignette](https://epiverse-trace.github.io/simulist/dev/articles/vis-linelist.md)),
...
- Exported functions that simulate data use the naming convention
  ...
  (e.g. [`.sim_internal()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-sim_internal.md)).
...
- Exported post-processing functions, i.e. those that are applied to the
  ...
  a verb or adjective,
  e.g. [`messy_linelist()`](https://epiverse-trace.github.io/simulist/dev/reference/messy_linelist.md)
  or
...
- The column names of the line list data produced by
  ...
  (e.g. [`.add_hospitalisation()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-add_cols.md)).
