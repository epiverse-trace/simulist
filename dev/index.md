...
[simulist](https://github.com/epiverse-trace/simulist) is an R package
to simulate individual-level infectious disease outbreak data, including
line lists and contact tracing data. It can often be useful to have
synthetic datasets like these available when demonstrating outbreak
analytics techniques or testing new analysis methods.

[simulist](https://github.com/epiverse-trace/simulist) is developed at
...
[simulist](https://github.com/epiverse-trace/simulist) allows you to
simulate realistic line list and contact tracing data, with:

⏳ Parameterised epidemiological delay distributions  
🏥 Population-wide or age-stratified hospitalisation and death risks  
📊 Uniform or age-structured populations  
📈 Constant or time-varying case fatality risk  
📋 Customisable probability of case types and contact tracing
follow-up  

Post-process simulated line list data for:

📅 Real-time outbreak snapshots with right-truncation  
📝 Messy data with inconsistencies, mistakes and missing values  
📒 Censor dates to daily, epi- and iso-weekly, yearly and other
groupings  
...
[simulist](https://github.com/epiverse-trace/simulist) from
...
A line list can be simulated by calling
[`sim_linelist()`](https://epiverse-trace.github.io/simulist/dev/reference/sim_linelist.md).
The function provides sensible defaults to quickly generate a
...
package if available, or if these are not in the
[epiparameter](https://github.com/epiverse-trace/epiparameter/) database
yet (such as the contact distribution for COVID-19) we can define them
ourselves. Here we define a contact distribution, period of
infectiousness, onset-to-hospitalisation delay, and onset-to-death
delay.
...
infection per contact of 0.5, we use the
[`sim_linelist()`](https://epiverse-trace.github.io/simulist/dev/reference/sim_linelist.md)
function. The mean number of contacts and probability of infection
determine the outbreak reproduction number, if the resulting
reproduction number is around one it means we will likely get a
reasonably sized outbreak (10 - 1,000 cases, varying due to the
...
(see
[`?sim_linelist`](https://epiverse-trace.github.io/simulist/dev/reference/sim_linelist.md)).
The default hospitalisation risk is assumed to be 0.2 (i.e. there is a
20% probability an infected individual becomes hospitalised) and the
start date of the outbreak is 1st January 2023. To modify either of
...
head(linelist)
#>   id         case_name case_type sex age date_onset date_reporting
#> 1  1    Karlena Garner confirmed   f  31 2019-12-01     2019-12-01
#> 2  3 Cassandra Le Beau suspected   f  47 2019-12-01     2019-12-01
#> 3  4      Lauren Moran confirmed   f   2 2019-12-01     2019-12-01
#> 4  5       Alexis Ware confirmed   f  24 2019-12-01     2019-12-01
#> 5  6       Sophia Cruz  probable   f  56 2019-12-01     2019-12-01
#> 6  7      Amanda Quast confirmed   f   8 2019-12-01     2019-12-01
#>   date_admission   outcome date_outcome date_first_contact date_last_contact
#> 1           <NA> recovered         <NA>               <NA>              <NA>
#> 2           <NA> recovered         <NA>         2019-11-28        2019-12-03
#> 3           <NA>      died   2019-12-25         2019-11-28        2019-12-07
#> 4           <NA> recovered         <NA>         2019-11-26        2019-12-02
#> 5           <NA> recovered         <NA>         2019-11-28        2019-12-04
#> 6           <NA>      died   2019-12-16         2019-11-30        2019-12-05
#>   ct_value
#> 1     26.3
#> 2       NA
#> 3     26.2
...
#> 1 Ivory Bing-Turner       Umar al-Edris  63   m         2022-12-30
#> 2 Ivory Bing-Turner           Scott Kim  10   m         2022-12-30
#> 3 Ivory Bing-Turner     Alyssa Harrison  24   f         2022-12-28
#> 4 Ivory Bing-Turner Nhuquynh Kodicherla  10   f         2022-12-29
#> 5 Ivory Bing-Turner      Carmen Montoya  56   f         2023-01-01
#> 6         Scott Kim          Ryan Moore   4   m         2022-12-31
#>   date_last_contact was_case         status
#> 1        2023-01-05    FALSE under_followup
...
#> 1  1  Steffano Jones confirmed   m  87 2023-01-01     2023-01-01           <NA>
#> 2  2     Mahmoud Lee confirmed   m  17 2023-01-01     2023-01-01     2023-01-04
#> 3  4 Jaicy Collareno  probable   f  68 2023-01-01     2023-01-01           <NA>
#> 4  5  Chandler Allen confirmed   f  34 2023-01-01     2023-01-01           <NA>
#> 5  8   Destiny Crown  probable   f  47 2023-01-01     2023-01-01           <NA>
#> 6  9 Jacob Littleman  probable   m  72 2023-01-01     2023-01-01     2023-01-05
#>     outcome date_outcome date_first_contact date_last_contact ct_value
#> 1 recovered         <NA>               <NA>              <NA>     24.8
#> 2 recovered         <NA>         2022-12-29        2023-01-03     24.7
#> 3 recovered         <NA>         2022-12-29        2023-01-04       NA
#> 4 recovered         <NA>         2022-12-31        2023-01-01     25.4
#> 5 recovered         <NA>         2022-12-30        2023-01-03       NA
#> 6      died   2023-01-22         2022-12-28        2023-01-01       NA
head(outbreak$contacts)
#>              from                to age sex date_first_contact
#> 1  Steffano Jones       Mahmoud Lee  17   m         2022-12-29
#> 2  Steffano Jones   Cooper Straight  11   m         2022-12-26
#> 3     Mahmoud Lee   Jaicy Collareno  68   f         2022-12-29
#> 4 Jaicy Collareno    Chandler Allen  34   f         2022-12-31
#> 5 Jaicy Collareno Cheyenne Trujillo  58   f         2022-12-29
#> 6 Jaicy Collareno   Cameron Barajas  22   m         2022-12-29
#>   date_last_contact was_case           status
#> 1        2023-01-03     TRUE             case
#> 2        2023-01-05    FALSE   under_followup
#> 3        2023-01-04     TRUE             case
#> 4        2023-01-01     TRUE             case
#> 5        2023-01-04    FALSE lost_to_followup
...
Contributions to [simulist](https://github.com/epiverse-trace/simulist)
are welcomed. Please follow the [package contributing
guide](https://github.com/epiverse-trace/.github/blob/main/CONTRIBUTING.md).

## Code of Conduct

Please note that the
[simulist](https://github.com/epiverse-trace/simulist) project is
...
To cite the [simulist](https://github.com/epiverse-trace/simulist)
package, please cite the publication in the Journal of Open Source
...
📦 ↔︎️ 📦 [{incidence2}](https://www.reconverse.org/incidence2/)  
📦 ↔︎️ 📦 [{cleanepi}](https://epiverse-trace.github.io/cleanepi/)  
...
- [`{simulacr}`](https://github.com/reconhub/simulacr) uses a branching
  ...
  packages
  ([epicontacts](https://www.repidemicsconsortium.org/epicontacts/) and
  [distcrete](https://github.com/reconhub/distcrete)) to parameterise
  and plot simulated data.
...
used, either independently or in combination with
