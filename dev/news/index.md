...
- [`.check_linelist()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-check_linelist.md)
  is added for input checking in post-processing functions
  ([\#179](https://github.com/epiverse-trace/simulist/issues/179)).

- `.check_age_df()` and `.check_risk_df()` have been merged into
  [`.check_df()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-check_df.md)
...
- Outcome date (`$date_outcome`) is now conditioned to be after
  ...
  [`.sample_outcome_time()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-sample_outcome_time.md)
...
- [`.add_hospitalisation()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-add_cols.md)
  ...
  [`.add_outcome()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-add_cols.md)
...
- [`.add_ct()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-add_cols.md)
...
- [`.cross_check_sim_input()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-cross_check_sim_input.md)
  function has been added to the package to ensure user input is
  coherent across arguments
  ([\#98](https://github.com/epiverse-trace/simulist/issues/98)).

- [`.anonymise()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-anonymise.md)
...
- [`.sim_network_bp()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-sim_network_bp.md)
  ...
  ([\#60](https://github.com/epiverse-trace/simulist/issues/60)).
- [`.sample_names()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-sample_names.md)
...
- Refactor of internal simulation architecture replaced
  ...
  [`.sim_internal()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-sim_internal.md)
  ([\#66](https://github.com/epiverse-trace/simulist/issues/66)).
...
- [`.add_date_contact()`](https://epiverse-trace.github.io/simulist/dev/reference/dot-add_cols.md)
