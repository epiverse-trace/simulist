...
![The daily incidence of cases, hospitalisations and deaths, facetted by sex for a simulated outbreak.\label{fig:simulist}](incidence.png){ width=33% } ![A contact network for a simulated outbreak](network.png){ width=33% }
