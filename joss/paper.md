...
![A connected dot plot of the timeline of events in a simulated line list. See _Visualising simulated data vignette_ at https://epiverse-trace.github.io/simulist/articles/vis-linelist.html or in R (`vignette("vis-linelist", package = "simulist")`) for more information.\label{fig:events}](multi-dot-plot.png)
