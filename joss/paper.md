...
![Part a. The daily incidence of cases, hospitalisations and deaths, facetted by sex for a simulated outbreak.](incidence.png){ width=33% } ![Part b. A contact network for a simulated outbreak](network.png){ width=33% } ![Part c. A multi-dot plot for the events in a simulated line list. \label{fig:simulist}](multi-dot-plot.png){ width=33% }
