...
The reporting delay can be specified as a (random) number generating function to the `config` argument in `sim_linelist()`. The function can be defined with the name `reporting_delay` to `create_config()`.
