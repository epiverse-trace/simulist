...
.create_linelist <- function(scenario) {
  ...
  if (scenario >= 5) {
    linelist <- cbind(
      linelist,
      deaths = c(
        NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, 15.36087, 9.57958,
        19.16273, NA, NA, NA, NA, NA, NA, NA, NA, 12.41865, NA, NA, NA, NA,
        28.18955, NA, NA, 25.33905, NA, 18.07705, 18.21541, NA, NA, NA, NA,
        NA, NA, NA
      ),
      date_admission = as.Date(c(
