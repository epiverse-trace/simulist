...
- [`{LLsim}`](https://github.com/jrcpulliam/LLsim) simulates line list data using a stochastic SIR model with a fixed population with observation and reporting delays.
...
\* We define actively maintained as the repository having a commit to the main branch within the last 12 months
